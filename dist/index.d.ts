...
// Selector types
type Selector = string | Element | NodeList | Element[] | null;
 ...
 */
declare function DOMUtilsLibrary(selector?: Selector): DOMUtilsCore;

/**
 * DOMUtils namespace with all sub-modules
 */
declare namespace DOMUtilsLibrary {
...
declare function qs(selector: string, root?: Element | Document): Element | null;
declare function qsAll(selector: string, root?: Element | Document): Element[];
declare const $: typeof DOMUtilsLibrary;

declare const $: typeof DOMUtilsLibrary;

export { $, type AjaxOptions, type DOMUtilsCore, DOMUtilsLibrary, type DOMUtilsRoot, type DragController, type DragInfo, type DragOptions, Modal, type ModalOptions, type ObserverHandle, type Selector, type Signal, type StateProxy, type SwipeInfo, type SwipeOptions, Tabs, type TabsOptions, Tooltip, type TooltipOptions, type DOMUtilsRoot as default, qs, qsAll };
