...
describe("Create - Form Elements", () => {
    ...
    describe("createLabel()", () => {
        ...
        it("should create label with additional attributes", () => {
            const label = createLabel("Name", "name-input", {
                class: "form-label"
            });
...
describe("Create - UI Components", () => {
    describe("createCard()", () => {
        it("should create card with title and body", () => {
            ...
            expect(card.querySelector(".card-header")?.textContent).toBe(
                "Card Title"
            );
        ...
        it("should create card with footer", () => {
            ...
            expect(card.querySelector(".card-footer")?.textContent).toBe(
                "Footer text"
            );
        });
    ...
    describe("createModal()", () => {
        it("should create modal with title and body", () => {
            ...
            expect(modal.querySelector(".modal-header h2")?.textContent).toBe(
                "Confirm"
            );
        ...
        it("should create modal with footer", () => {
            ...
            expect(modal.querySelector(".modal-footer")?.textContent).toBe(
                "Footer"
            );
        });
    ...
    describe("createNav()", () => {
        ...
        it("should apply custom class", () => {
            const nav = createNav([{ label: "Home", href: "/" }], {
                className: "main-nav"
            });
